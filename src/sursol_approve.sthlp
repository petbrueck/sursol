...
{phang}
{opt rpath(string)} specifies the path to the R.exe through which the data export request to the server is transmitted. Required if non-windows OS. By default, and if windows as OS is used, {opt sursol approve} assumes that the executable  
...
{pstd}{cmd:sursol approve} was last updated using Survey Solutions 20.05
