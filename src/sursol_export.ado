...
if length("`directory'")==0 & length("`dropbox'")==0 {
noi dis as error _n "Attention. You need to specify a {it:file-destination}."
noi dis as error "Specify either {help sursol_export##sursol_export_directory:directory({it:string})} or {help sursol_export##dropbox:dropbox({it:access_token})}.
ex 601
}
